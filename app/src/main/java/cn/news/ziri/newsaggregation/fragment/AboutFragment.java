...
public class AboutFragment extends BaseFragment {
    ...
    private void initview(View view){
        VersionCheck= (Button) view.findViewById(R.id.versioncheckbutton);
        Policy= (Button) view.findViewById(R.id.policybutton);
        AboutUs= (Button) view.findViewById(R.id.aboutusbutton);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            boolean flag=true;
            mListener.onFragmentInteraction(flag);
        }
    }
